package com.ihujia.hujia.update.service;
...
public class UpdateService extends Service {
	...
	public static final String DOWNLOAD_FOLDER_NAME = "ihujia";
	public static final String DOWNLOAD_FILE_NAME = "ihujia_client_new.apk";
