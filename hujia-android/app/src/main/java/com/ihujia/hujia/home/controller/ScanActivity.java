...
import com.ihujia.hujia.login.controller.ScanLoginActivity;
...
public class ScanActivity extends BaseActivity implements SurfaceHolder.Callback {
	...
	private static final int REQUEST_NET_LOGIN_PC = 10;
	...
	public void handleDecode(String result) {
		...
		if (!TextUtils.isEmpty(result) && result.startsWith("http")) {
			if (UserCenter.isLogin(this)) {
				ScanLoginActivity.startScanLoginActivity(this, result);
			} else {
	...
	public void success(int requestCode, String data) {
		closeProgressDialog();
		if (REQUEST_NET_LOGIN_PC == requestCode) {
