...
public final class LocationUtils {
	...
	/**
	 * @param context Activity实例需要回调更新页面操作的Activity需要实现BDLocationListener
	 */
...
//                sb.append(location.getAddrStr());
	...
	private static void setLocation(Context context, BDLocation location) {
		PreferencesUtils.putString(context, LOCATION_PRE_KEY_LAT, String.valueOf(location.getLatitude()));
		PreferencesUtils.putString(context, LOCATION_PRE_KEY_LON, String.valueOf(location.getLongitude()));
	}
