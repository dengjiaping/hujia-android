...
import com.ihujia.hujia.person.controller.PaySuccessActivity;
...
public final class PayUtils {
	...
	public static void gotoPaySuccess(Context context) {
		...
		intent.putExtra(PaySuccessActivity.EXTRA_FROM, PaySuccessActivity.FROM_PAY);
		intent.putExtra(PaySuccessActivity.EXTRA_MONEY, ConfirmChooseActivity.amount);
