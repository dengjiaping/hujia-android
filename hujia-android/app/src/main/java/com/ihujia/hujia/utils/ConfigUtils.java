...
public class ConfigUtils {
	...
	private static final String CONFIG_PRE_KEY_SHOW_GUIDE = "pre_key_show_guide";
	private static final String CONFIG_PRE_KEY_OLD_VERSION_CODE = "pre_key_old_version_code";
	private static final String CONFIG_PRE_KEY_IGNORE_DATE = "pre_key_ignore_date";
	private static final String CONFIG_PRE_KEY_PAY_VERIFYPWD_TIMES = "pre_key_loc_verifypwd_times";
