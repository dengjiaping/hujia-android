...
import com.ihujia.hujia.person.adapter.CityListAdapter;
...
public class SelectCityActivity extends ToolBarActivity implements AdapterView.OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		if (GET_PROVINCE_CODE.equals(type)) {
			...
			cityCurrentCity.setText(String.format(res.getString(R.string.person_info_city_current), province + city + district));
